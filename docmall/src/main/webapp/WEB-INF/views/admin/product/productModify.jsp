					    ...
					    <div class="col-sm-3">
					    	<select name="cate_code_prt" id="firstCategory" class="form-control">
					    		...
					    		<c:forEach items="${cateList }" var="categoryVO">
					    			<option value="${categoryVO.cate_code }" ${ categoryVO.cate_code == productVO.cate_code_prt ? 'selected':'' }>${categoryVO.cate_name }</option>
					    		</c:forEach>
					    	</select>
					    </div>
						<div class="col-sm-3">					    	
					    	<select name="cate_code" id="secondCategory" class="form-control">
					    		...
					    		<c:forEach items="${subCateList }" var="subCategoryVO">
					    			<option value="${subCategoryVO.cate_code }" ${ subCategoryVO.cate_code == productVO.cate_code ? 'selected':'' }>${subCategoryVO.cate_name }</option>
					    		</c:forEach>
					    	</select>
					    </div>
					  </div>
